...
@SubscribeTo(eventClass = AbstractEntity.class /*,
  jpaAction = {JPAActionType.Remove}*/)
public class IndexEventProcessorDeleteRunnable extends AbstractIndexEventProcessorRunnable {
  @Inject
  public IndexEventProcessorDeleteRunnable(
  ...
  protected IndexActivity doIndex() throws Exception {
    return (indexService.delete(indexableRecord));
  }
}
